...
func GetUnitDirectAntecessors(unit_id int64) []models.Unit {
...
func GetUnitDirectSuccessors(unit_id int64) []models.Unit {
...
func GetDependency(id int64) models.Dependency {
	var d models.Dependency
